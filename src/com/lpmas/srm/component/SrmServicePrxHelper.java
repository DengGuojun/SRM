...
package com.lpmas.srm.component;

public final class SrmServicePrxHelper extends Ice.ObjectPrxHelperBase implements SrmServicePrx
{
    ...
    public Ice.AsyncResult begin_rpc(String method, String params, Callback_SrmService_rpc __cb)
    {
        return begin_rpc(method, params, null, false, false, __cb);
    }

    public Ice.AsyncResult begin_rpc(String method, String params, java.util.Map<String, String> __ctx, Callback_SrmService_rpc __cb)
    {
        return begin_rpc(method, params, __ctx, true, false, __cb);
    }
                         ...
                         new IceInternal.Functional_TwowayCallbackArg1<String>(__responseCb, __exceptionCb, __sentCb)
                             {
                                 ...
                                 {
                                     SrmServicePrxHelper.__rpc_completed(this, __result);
                                 }
                             });
    }
    ...
    {
        com.lpmas.srm.component.SrmServicePrx __proxy = (com.lpmas.srm.component.SrmServicePrx)__result.getProxy();
        String __ret = null;
        try
        {
    ...
    public static SrmServicePrx checkedCast(Ice.ObjectPrx __obj)
    {
        return checkedCastImpl(__obj, ice_staticId(), SrmServicePrx.class, SrmServicePrxHelper.class);
    }

    public static SrmServicePrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __ctx, ice_staticId(), SrmServicePrx.class, SrmServicePrxHelper.class);
    }

    public static SrmServicePrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return checkedCastImpl(__obj, __facet, ice_staticId(), SrmServicePrx.class, SrmServicePrxHelper.class);
    }

    public static SrmServicePrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        return checkedCastImpl(__obj, __facet, __ctx, ice_staticId(), SrmServicePrx.class, SrmServicePrxHelper.class);
    }

    public static SrmServicePrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        return uncheckedCastImpl(__obj, SrmServicePrx.class, SrmServicePrxHelper.class);
    }

    public static SrmServicePrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        return uncheckedCastImpl(__obj, __facet, SrmServicePrx.class, SrmServicePrxHelper.class);
    }

    public static final String[] __ids =
    {
        "::Ice::Object",
        "::com::lpmas::srm::component::SrmService"
    };
    ...
    public static void __write(IceInternal.BasicStream __os, SrmServicePrx v)
    {
        __os.writeProxy(v);
    }

    public static SrmServicePrx __read(IceInternal.BasicStream __is)
    {
        Ice.ObjectPrx proxy = __is.readProxy();
        if(proxy != null)
        {
            SrmServicePrxHelper result = new SrmServicePrxHelper();
